...
Practically, it works as a stub to keep code clean and concise without worrying about compile-time issues.
...
- **At runtime**: if execution actually *reaches* a `todo`, the program immediately panics and halts, providing an error telling you unimplemented code was reached.